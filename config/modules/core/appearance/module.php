 ...
 */
thb_define('THB_CUSTOMIZATIONS', 'thb_theme_customizations_' . THB_THEME_KEY);
...
if( ! function_exists('thb_render_customizations') ) {
	...
	add_action( 'update_option_theme_mods_'.THB_THEME_KEY, 'thb_render_customizations', 9999 );
}
