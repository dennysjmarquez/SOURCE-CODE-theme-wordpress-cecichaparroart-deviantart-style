...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function (a, b, c, d, e, g) {
        ...
        switch (a.method) {
        case "silverlight":
            k.innerHTML = '<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="' + l + '" name="' + l + '" width="' + f + '" height="' + h + '" class="mejs-shim"><param name="initParams" value="' + d.join(",") + '" /><param name="windowless" value="true" /><param name="background" value="black" /><param name="minRuntimeVersion" value="3.0.0.0" /><param name="autoUpgrade" value="true" /><param name="source" value="' +
        ...
        case "flash":
            if (mejs.MediaFeatures.isIE) {
                ...
                '<embed id="' + l + '" name="' + l + '" play="true" loop="false" quality="high" bgcolor="#000000" wmode="transparent" allowScriptAccess="always" allowFullScreen="true" type="application/x-shockwave-flash" pluginspage="//www.macromedia.com/go/getflashplayer" src="' + b.pluginPath + b.flashName + '" flashvars="' + d.join("&") + '" width="' + f + '" height="' + h + '" class="mejs-shim"></embed>';
            break;
        case "youtube":
...
(function (f) {
    ...
    mejs.MediaElementPlayer.prototype = {
                ...
                if (!(d.isAndroid && c.options.AndroidUseNativeControls) && !(d.isiPad && c.options.iPadUseNativeControls) && !(d.isiPhone && c.options.iPhoneUseNativeControls)) {
                    ...
                    a.addEventListener("play", function () {
                        for (var j in mejs.players) {
                            var k = mejs.players[j];
                            k.id != c.id && c.options.pauseOtherPlayers && !k.paused && !k.ended && k.pause();
                            k.hasFocus = false
                        }
                        c.hasFocus = true
                    }, false);
        ...
        setControlsSize: function () {
            ...
            if (b === 0 || !b) {
                ...
                b = this.controls.width() -
                    a - (c.outerWidth(true) - c.width())
            }
            c.width(b);
        ...
        buildoverlays: function (a, b, c, d) {
            ...
            if (a.isVideo) {
                var g = f('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(c),
                    l = f('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-error"></div></div>').hide().appendTo(c),
            ...
            this.globalBind("keydown",
                function (e) {
                    if (a.hasFocus && a.options.enableKeyboard)
                        for (var g = 0, l = a.options.keyActions.length; g < l; g++)
                            for (var j = a.options.keyActions[g], k = 0, s = j.keys.length; k < s; k++)
                                if (e.keyCode == j.keys[k]) {
                                    e.preventDefault();
        ...
        remove: function () {
            ...
            mejs.players.splice(f.inArray(this, mejs.players), 1);
    ...
    (function () {
        function a(c, d) {
            ...
            f.each((c || "").split(" "), function (g, l) {
                e[b.test(l) ? "w" : "d"].push(l + "." + d)
            });
            e.d = e.d.join(" ");
            e.w = e.w.join(" ");
            return e
...
(function (f) {
    f.extend(MediaElementPlayer.prototype, {
        buildprogress: function (a, b, c, d) {
            ...
            var l = b.find(".mejs-time-current"),
                j = b.find(".mejs-time-handle"),
                k = b.find(".mejs-time-float"),
                s = b.find(".mejs-time-float-current"),
                p = function (n) {
                    n = n.pageX;
                    var h = g.offset(),
                        q = g.outerWidth(true),
                        ...
                        o = m = 0;
                    if (d.duration) {
                        if (n < h.left) n = h.left;
                        else if (n > q + h.left) n = q + h.left;
                        o = n - h.left;
                        m = o / q;
                        m = m <= 0.02 ? 0 : m * d.duration;
                        r && m !== d.currentTime && d.setCurrentTime(m);
                        if (!mejs.MediaFeatures.hasTouch) {
                            k.css("left", o);
                            s.html(mejs.Utility.secondsToTimeCode(m));
                            k.show()
                        }
                    }
                }, r = false;
            g.bind("mousedown", function (n) {
                if (n.which === 1) {
                    r = true;
                    p(n);
                ...
                e.globalBind("mousemove.dur", function (n) {
                    p(n)
                });
            ...
            d.addEventListener("progress", function (n) {
                a.setProgressRail(n);
                a.setCurrentRail(n)
            }, false);
            d.addEventListener("timeupdate", function (n) {
                a.setProgressRail(n);
                a.setCurrentRail(n)
            }, false);
            e.loaded = c;
        ...
        buildvolume: function (a, b, c, d) {
            if (!(mejs.MediaFeatures.hasTouch && this.options.hideVolumeOnTouchDevices)) {
                var e = this,
                    ...
                    l = g == "horizontal" ? f('<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' + e.id + '" title="' + e.options.muteText +
                    ...
                    k = e.container.find(".mejs-volume-total, .mejs-horizontal-volume-total"),
                    s = e.container.find(".mejs-volume-current, .mejs-horizontal-volume-current"),
                    ...
                    r = function (m, o) {
                        if (!j.is(":visible") && typeof o == "undefined") {
                            ...
                            m = Math.max(0, m);
                            m = Math.min(m, 1);
                            m == 0 ? l.removeClass("mejs-mute").addClass("mejs-unmute") : l.removeClass("mejs-unmute").addClass("mejs-mute");
                            if (g == "vertical") {
                                var t = k.height(),
                                    u = k.position(),
                                    v = t - t * m;
                                ...
                                u = k.position();
                                t = t * m;
                                p.css("left", Math.round(u.left + t - p.width() / 2));
                                s.width(Math.round(t))
                            }
                        }
                    }, n = function (m) {
                        var o = null,
                        ...
                        if (g == "vertical") {
                            o = k.height();
                            parseInt(k.css("top").replace(/px/, ""), 10);
                            o = (o - (m.pageY - t.top)) / o;
                ...
                d.addEventListener("volumechange", function () {
                    if (!h)
                        if (d.muted) {
                            r(0);
                            l.removeClass("mejs-mute").addClass("mejs-unmute")
                        } else {
                            r(d.volume);
                            l.removeClass("mejs-unmute").addClass("mejs-mute")
                        }
                }, false);
                if (e.container.is(":visible")) {
                    r(a.options.startVolume);
            ...
            if (a.isVideo) {
                ...
                if (e.media.pluginType === "native" || !e.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox) g.click(function () {
                    ...
                    if (function () {
                        ...
                        var j = false,
                            ...
                            }, s = f('<div class="mejs-fullscreen-hover" />').appendTo(e.container).mouseover(k),
                            p = f('<div class="mejs-fullscreen-hover"  />').appendTo(e.container).mouseover(k),
                            r = f('<div class="mejs-fullscreen-hover"  />').appendTo(e.container).mouseover(k),
                            n = function () {
                                var h = {
                                    position: "absolute",
                                    top: 0,
                                ...
                                p.css(h);
                                r.css(h);
                                s.width(e.container.width()).height(e.container.height() - e.controls.height());
                                h = g.offset().left - e.container.offset().left;
                                fullScreenBtnWidth =
                                    g.outerWidth(true);
                                p.width(h).height(e.controls.height()).css({
                                    top: e.container.height() - e.controls.height()
                                });
                                r.width(e.container.width() - h - fullScreenBtnWidth).height(e.controls.height()).css({
                                    top: e.container.height() - e.controls.height(),
                                    left: h + fullScreenBtnWidth
                                })
                            };
                        ...
                        g.mouseover(function () {
                            if (!e.isFullScreen) {
                                var h = g.offset(),
                                    q = a.container.offset();
                                d.positionFullscreenButton(h.left - q.left, h.top - q.top, false);
                        ...
                        var h = g.offset(),
                            q = a.container.offset();
                        d.positionFullscreenButton(h.left - q.left, h.top - q.top, true)
                    }).mouseout(function () {
                        if (l !== null) {
                            clearTimeout(l);
                            delete l
                ...
                e.globalBind("keydown", function (h) {
                    if ((mejs.MediaFeatures.hasTrueNativeFullScreen && mejs.MediaFeatures.isFullScreen() ||
                        e.isFullScreen) && h.keyCode == 27) a.exitFullScreen()
                })
            }
        },
        ...
        buildtracks: function (a, b, c, d) {
            if (a.isVideo)
                if (a.tracks.length != 0) {
                    ...
                    a.captionsButton = f('<div class="mejs-button mejs-captions-button"><button type="button" aria-controls="' + this.id + '" title="' + this.options.tracksText + '"></button><div class="mejs-captions-selector"><ul><li><input type="radio" name="' + a.id + '_captions" id="' + a.id + '_captions_none" value="none" checked="checked" /><label for="' + a.id + '_captions_none">None</label></li></ul></div></div>').appendTo(b);
...
(function (f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function (a, b) {
            for (var c =
                this, d = "", e = c.options.contextMenuItems, g = 0, l = e.length; g < l; g++)
            ...
            c.contextMenu.find(".mejs-contextmenu-item").each(function () {
                var k = f(this),
                    s = parseInt(k.data("itemindex"), 10),
                    p = c.options.contextMenuItems[s];
