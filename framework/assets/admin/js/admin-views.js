...
var THB_Post = Backbone.View.extend({
	...
	initialize: function() {
		...
		this.metaboxes = this.$('#metabox_post_gallery, #metabox_post_quote, #metabox_post_video, #metabox_post_audio, #metabox_post_link, #wpcf-group-choose-a-image');
	...
	groupChange: function() {
		...
		this.group.each(function() {
			if( jQuery(this).is(':checked') ) {
				...
				var arrChkBox = document.getElementsByName("wpcf[image]");
				//jQuery(arrChkBox).val('');
				
				
				var val = jQuery(this).val();

				jQuery('#metabox_post_' + val).show();
				jQuery('#wpcf-group-choose-a-' + val).show();
