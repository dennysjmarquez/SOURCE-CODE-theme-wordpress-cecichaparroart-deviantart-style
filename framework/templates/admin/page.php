<?php
	...
	if( isset($_SESSION['flashdata']['message']) ) {
		$thb_post_msg = $_SESSION['flashdata']['message'];
		$thb_post_msg_type = $_SESSION['flashdata']['type'];

		unset($_SESSION['flashdata']);
	}
?>
<div class="thb-msg-container" data-type="<?php echo $thb_post_msg_type; ?>" data-message="<?php echo $thb_post_msg; ?>"></div>
