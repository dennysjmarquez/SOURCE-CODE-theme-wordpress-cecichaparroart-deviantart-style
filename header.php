...
function scroll1(si){
		...
		if ($(window).scrollTop() >= 514 ){
			...
			if(barrascro1 == false ){
				barrascro1 = true;
				barrascro2 = false;
				$('#barra').removeClass("barra2").addClass("barra3");
				$('#botv').css('display','');
				$('#bottonv').removeClass("right-buttons").addClass("right-buttons2");
				$('#container-search').removeClass("container-search").addClass("container-search2");
			...
			if(barrascro2 == false){
				barrascro2 = true;
				barrascro1 = false;
				$('#botv').css('display','none');
				$('#barra').removeClass("barra3").addClass("barra2");
				$('#bottonv').removeClass("right-buttons2").addClass("right-buttons");
				$('#container-search').removeClass("container-search2").addClass("container-search");
				$('#container-search').css('display','');
...
<div class="banner">
<div class="mp">
<table border="1" width="100%" id="menub" class="menub">
	<tr>
		<td>
...
<div class="banl"></div>
<div class="banr"></div>
<div id="randp" style="text-align: center;padding-top: 10px;margin-left: -6px;padding-bottom: 41px;">
